  ...
  <section className="pt-24 pb-5 lg:pt-28 lg:pb-6">
    <div className="container mx-auto max-w-3xl px-4">
      ...
      <div className="mt-3 space-y-3">
        <P>
          Информируем вас о важных изменениях в условиях сотрудничества, связанных с вступлением в силу с 1 сентября 2026 года Федерального закона от 01.09.2026 № 321 ФЗ «Об особенностях регулирования платформенной деятельности и платформенной занятости» (далее — Закон о платформенной деятельности).
        </P>
        <P>
  ...
  <Section className="!py-6 lg:!py-7">
    <div className="container mx-auto max-w-3xl px-4">
      ...
      <ul className="mt-2 space-y-2 text-sm leading-relaxed text-slate-700">
        <li>Федеральный закон от 01.09.2026 № 321 ФЗ «Об особенностях регулирования платформенной деятельности и платформенной занятости», ст. 11, 12, 18.</li>
